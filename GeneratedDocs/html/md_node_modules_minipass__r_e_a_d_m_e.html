...
<h2><a class="anchor" id="autotoc_md2693"></a>
Timing</h2>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md2699"></a>
USAGE</h1>
...
<li><code>destroy([er])</code> - Destroy the stream. If an error is provided, then an &lsquo;'error&rsquo;<code>event is emitted. If the stream has a</code><a class="el" href="namespaceeosdac.html#a95b84859fa6195cc01a5a13a0f0085e6">close()</a><code>method, and has not emitted a</code>'close'<code>event yet, then</code><a class="el" href="namespaceeosdac.html#a95b84859fa6195cc01a5a13a0f0085e6">stream.close()</a><code>will be called. Any Promises returned by</code>.promise()<code>,</code>.collect()<code>or </code>.concat()` will be rejected. After being destroyed, writing to the stream will emit an error. No more data will be emitted if the stream is destroyed, even if it was previously buffered.</li>
</ul>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2711"></a>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2713"></a>
