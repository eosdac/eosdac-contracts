...
namespace nft {
    ...
    inline auto get_immutable_data(const atomicassets::assets_s &nft) {
    ...
    template <typename T> inline auto get_immutable_attr(const atomicassets::assets_s &nft, const string &attr_name) {
