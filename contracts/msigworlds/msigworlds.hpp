...
namespace eosio {
     ...
     */
    class [[eosio::contract("msigworlds")]] multisig : public contract {
      public:
         ...
         */
        ACTION approve(name proposal_name, permission_level level, name dac_id,
    ...
    TABLE proposal {
        ...
        PropState                                          state = PropState::PENDING;
    ...
    typedef eosio::multi_index<"proposal"_n, proposal,
